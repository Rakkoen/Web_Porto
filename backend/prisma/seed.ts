    ...
    data: [
      {
        ...
        githubUrl: 'https://github.com/rakhahendriansyah/fleet-monitoring',
      ...
      },
      {
        ...
        demoUrl: 'https://demo.example.com',
        githubUrl: 'https://github.com/rakhahendriansyah/network-tool',
        category: 'Networking',
        featured: true,
      },
      {
        ...
        demoUrl: 'https://demo.example.com',
        githubUrl: 'https://github.com/rakhahendriansyah/ecommerce',
        category: 'Web Development',
        featured: false,
      },
    ],
    ...
    data: [
      {
        ...
        content: 'Rakha delivered our fleet monitoring system on time and exceeded our expectations. The system has improved our operational efficiency by 40%.',
        featured: true,
      },
      {
        name: 'Sarah Wijaya',
        position: 'CTO',
        company: 'EcomStore',
        content: 'Working with Rakha was a great experience. His technical expertise and problem-solving skills helped us launch our e-commerce platform successfully.',
        featured: true,
      },
    ],
    skipDuplicates: true,
